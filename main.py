class AdvancedCalculator:
    ...
    def square_root(self, val:int) -> float:
        ...
        guess = val / 2
        while True:
            next_guess = 0.5 * (guess + val/guess)
    ...
    def exponents(self, base:int, power:int):
        return base ** power
    ...
    def sine_taylor(self, x, terms=5):
        """
        Taylor Series Formula for Sine:
    ...
    def emi_calculator(self, loan_amount: float, ann_interest: float, duration_months: int) -> float:
        """
        ...
        r = ann_interest/(12 * 100)

        # Apply EMI formula
        A = (1 + r) ** duration_months
        N = loan_amount * r * A
        emi = N / (A - 1)
    ...
    def percentage_calculator(self, percentage: float, num: float) -> float:
        calculated_percentage = (percentage * num) / 100
    ...
    def run(self):
        ...
        print("-" * 40)
        print("We support different types of calculators:\n \
               \na) Basic calculator-> +, -, *, / \
        ...
        while True:
            ...
            if calculator_type in calculator_map:
                if calculator_map[calculator_type] == "basic":
                    ...
                    if operator == 1 or operator == 2:   #square root, factorial
                    ...
                    elif operator == 4 or operator == 5:  #nth root, logarithm
                    ...
                    if operator == 1:   #EMI calculator
                        ...
                        self.result = self.emi_calculator(loan_amount, ann_interest, duration)
